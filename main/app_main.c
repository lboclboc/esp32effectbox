...
#endif
#define FLANGER_DRY FIXED_DECIMAL(1)
...
#define GET_SAMPLE() (integral += (((*sample_in) & 0xFFF)<< 4) + INT16_MIN, ((int16_t)((*sample_in++) & 0x0FFF) << 4) + INT16_MIN - dc_offset)
...
void dump_i2s_registers(int i2s_num)
{
	ESP_LOGI(TAG, "I2S_CLKM_CONF_REG%d", i2s_num);
    ...
    ESP_LOGI(TAG, "I2S_CONF_REG%d", i2s_num);
    ...
    ESP_LOGI(TAG, "I2S_CONF1_REG%d", i2s_num);
    ...
    ESP_LOGI(TAG, "I2S_CONF2_REG%d", i2s_num);
    ...
    ESP_LOGI(TAG, "I2S_SAMPLE_RATE_CONF_REG%d", i2s_num);
    ...
    ESP_LOGI(TAG, "I2S_FIFO_CONF_REG%d", i2s_num);
    ...
    ESP_LOGI(TAG, "I2S_PDM_FREQ_CONF_REG%d", i2s_num);
    ...
    ESP_LOGI(TAG, "I2S_PDM_CONF_REG%d", i2s_num);
...
{
	ESP_LOGI(TAG, "I2S0:");
	dump_i2s_registers(0);

	ESP_LOGI(TAG, "I2S1:");
	dump_i2s_registers(1);

	ESP_LOGI(TAG, "APB_CTRL_APB_SARADC_CTRL_REG"); // BUG: wrong name in the esp-idf for ESP32 or error in ref-manual
//	ESP_LOGI(TAG, "  APB_SARADC_DATA_TO_I2S = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_DATA_TO_I2S)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_DATA_SAR_SEL = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_DATA_SAR_SEL)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR2_PATT_P_CLEAR = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR2_PATT_P_CLEAR)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR1_PATT_P_CLEAR = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR1_PATT_P_CLEAR)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR2_PATT_LEN = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR2_PATT_LEN)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR1_PATT_LEN = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR1_PATT_LEN)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR_CLK_DIV = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR_CLK_DIV)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR_CLK_GATED = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR_CLK_GATED)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR_SEL = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR_SEL)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_WORK_MODE = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_WORK_MODE)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR2_MUX = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_SAR2_MUX)); // Not for any ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_START = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_START)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_START_FORCE = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL_REG, APB_SARADC_START_FORCE)); // Not for plain ESP32

	ESP_LOGI(TAG, "APB_CTRL_APB_SARADC_CTRL2_REG"); // BUG: wrong name in the esp-idf for ESP32 or error in ref-manual
//	ESP_LOGI(TAG, "  APB_SARADC_SAR2_INV = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL2_REG, APB_SARADC_SAR2_INV)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_SAR1_INV = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL2_REG, APB_SARADC_SAR1_INV)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_MAX_MEAS_NUM = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL2_REG, APB_SARADC_MAX_MEAS_NUM)); // Not for plain ESP32
//	ESP_LOGI(TAG, "  APB_SARADC_MEAS_NUM_LIMIT = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL2_REG, APB_SARADC_MEAS_NUM_LIMIT)); // Not for plain ESP32

	ESP_LOGI(TAG, "APB_CTRL_SARADC_DATA_TO_I2S = %d", REG_GET_FIELD(APB_CTRL_APB_SARADC_CTRL2_REG, APB_CTRL_SARADC_DATA_TO_I2S));

	ESP_LOGI(TAG, "APB_SARADC_FSM_REG = %d", REG_READ(APB_CTRL_APB_SARADC_FSM_REG)); // BUG: wrong name in the esp-idf for ESP32 or error in ref-manual

	ESP_LOGI(TAG, "SENS_SAR_READ_CTRL_REG:");
	ESP_LOGI(TAG, "  SENS_SAR1_DATA_INV = %d", REG_GET_FIELD(SENS_SAR_READ_CTRL_REG, SENS_SAR1_DATA_INV));
	ESP_LOGI(TAG, "  SENS_SAR1_DIG_FORCE = %d", REG_GET_FIELD(SENS_SAR_READ_CTRL_REG, SENS_SAR1_DIG_FORCE));
	ESP_LOGI(TAG, "  SENS_SAR1_SAMPLE_BIT = %d", REG_GET_FIELD(SENS_SAR_READ_CTRL_REG, SENS_SAR1_SAMPLE_BIT));
	ESP_LOGI(TAG, "  SENS_SAR1_SAMPLE_CYCLE = %d", REG_GET_FIELD(SENS_SAR_READ_CTRL_REG, SENS_SAR1_SAMPLE_CYCLE));
	ESP_LOGI(TAG, "  SENS_SAR1_CLK_DIV = %d", REG_GET_FIELD(SENS_SAR_READ_CTRL_REG, SENS_SAR1_CLK_DIV));

	ESP_LOGI(TAG, "SENS_SAR_START_FORCE_REG");
	ESP_LOGI(TAG, "  SENS_SAR1_STOP = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_SAR1_STOP));
	ESP_LOGI(TAG, "  SENS_SAR2_STOP = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_SAR2_STOP));
	ESP_LOGI(TAG, "  SENS_PC_INIT = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_PC_INIT));
	ESP_LOGI(TAG, "  SENS_ULP_CP_START_TOP = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_ULP_CP_START_TOP));
	ESP_LOGI(TAG, "  SENS_ULP_CP_FORCE_START_TOP = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_ULP_CP_FORCE_START_TOP));
	ESP_LOGI(TAG, "  SENS_SAR2_PWDET_CCT = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_SAR2_PWDET_CCT));
	ESP_LOGI(TAG, "  SENS_SAR2_EN_TEST = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_SAR2_EN_TEST));
	ESP_LOGI(TAG, "  SENS_SAR2_BIT_WIDTH = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_SAR2_BIT_WIDTH));
	ESP_LOGI(TAG, "  SENS_SAR1_BIT_WIDTH = %d", REG_GET_FIELD(SENS_SAR_START_FORCE_REG, SENS_SAR1_BIT_WIDTH));


	ESP_LOGI(TAG, "SENS_SAR_ATTEN1_REG = 0x%X", REG_READ(SENS_SAR_ATTEN1_REG));
	ESP_LOGI(TAG, "SENS_SAR_ATTEN2_REG = 0x%X", REG_READ(SENS_SAR_ATTEN2_REG));

	ESP_LOGI(TAG, "SENS_SAR_MEAS_START1_REG");
	ESP_LOGI(TAG, "  SENS_SAR1_EN_PAD_FORCE = %d", REG_GET_FIELD(SENS_SAR_MEAS_START1_REG, SENS_SAR1_EN_PAD_FORCE));
	ESP_LOGI(TAG, "  SENS_SAR1_EN_PAD = %d", REG_GET_FIELD(SENS_SAR_MEAS_START1_REG, SENS_SAR1_EN_PAD));
	ESP_LOGI(TAG, "  SENS_MEAS1_START_FORCE = %d", REG_GET_FIELD(SENS_SAR_MEAS_START1_REG, SENS_MEAS1_START_FORCE));
	ESP_LOGI(TAG, "  SENS_MEAS1_START_SAR = %d", REG_GET_FIELD(SENS_SAR_MEAS_START1_REG, SENS_MEAS1_START_SAR));
	ESP_LOGI(TAG, "  SENS_MEAS1_DONE_SAR = %d", REG_GET_FIELD(SENS_SAR_MEAS_START1_REG, SENS_MEAS1_DONE_SAR));
	ESP_LOGI(TAG, "  SENS_MEAS1_DATA_SAR = %d", REG_GET_FIELD(SENS_SAR_MEAS_START1_REG, SENS_MEAS1_DATA_SAR));
